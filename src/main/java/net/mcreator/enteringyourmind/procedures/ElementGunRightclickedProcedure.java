...
public class ElementGunRightclickedProcedure {
		...
		if (InputConstants.isKeyDown(Minecraft.getInstance().getWindow().getWindow(), InputConstants.KEY_LSHIFT)) {
			{
				...
				if (_plr.level().isClientSide())
					return;
				net.minecraft.world.item.Item fromItem = net.minecraftforge.registries.ForgeRegistries.ITEMS.getValue(new net.minecraft.resources.ResourceLocation("enteringyourmind:element_gun"));
				net.minecraft.world.item.Item toItem = net.minecraftforge.registries.ForgeRegistries.ITEMS.getValue(new net.minecraft.resources.ResourceLocation("enteringyourmind:element_gun_fire"));
			...
			if (itemstack.getItem() instanceof ElementGunItem)
				itemstack.getOrCreateTag().putString("geckoAnim", "animation.elementgun.shoot");
			for (int index0 = 0; index0 < 10; index0++) {
				particleAmount = 15;
				particleRadius = 2;
				for (int index1 = 0; index1 < (int) particleAmount; index1++) {
					world.addParticle((SimpleParticleType) (EnteringyourmindModParticleTypes.MAGIC_1.get()), (entity.level()
					...
					world.addParticle((SimpleParticleType) (EnteringyourmindModParticleTypes.MAGIC_2.get()), (entity.level()
							.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale((3 + Mth.nextInt(RandomSource.create(), 1, 10)))), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity))
							.getBlockPos().getX() + 0 + Mth.nextDouble(RandomSource.create(), -1, 1) * particleRadius),
							(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(3)), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity)).getBlockPos().getY() + 0
									+ Mth.nextDouble(RandomSource.create(), 0, 0.5) * particleRadius),
							(entity.level()
									...
									.getBlockPos().getZ() + 0 + Mth.nextDouble(RandomSource.create(), -1, 1) * particleRadius),
							(Mth.nextDouble(RandomSource.create(), 0, 0.005)), (Mth.nextDouble(RandomSource.create(), 0, 0.001)), (Mth.nextDouble(RandomSource.create(), 0, 0.005)));
					world.addParticle((SimpleParticleType) (EnteringyourmindModParticleTypes.MAGIC_22.get()), (entity.level()
							.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale((3 + Mth.nextInt(RandomSource.create(), 1, 10)))), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity))
							.getBlockPos().getX() + 0 + Mth.nextDouble(RandomSource.create(), -1, 1) * particleRadius),
							(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(3)), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity)).getBlockPos().getY() + 0
									+ Mth.nextDouble(RandomSource.create(), 0, 0.5) * particleRadius),
							(entity.level()
									.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale((3 + Mth.nextInt(RandomSource.create(), 1, 10)))), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE,
											entity))
									.getBlockPos().getZ() + 0 + Mth.nextDouble(RandomSource.create(), 0, 1) * particleRadius),
							(Mth.nextDouble(RandomSource.create(), 0, 0.005)), (Mth.nextDouble(RandomSource.create(), 0, 0.001)), (Mth.nextDouble(RandomSource.create(), 0, 0.005)));
					world.addParticle((SimpleParticleType) (EnteringyourmindModParticleTypes.MAGIC_23.get()), (entity.level()
							.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale((3 + Mth.nextInt(RandomSource.create(), 1, 10)))), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity))
							.getBlockPos().getX() + 0 + Mth.nextDouble(RandomSource.create(), -1, 1) * particleRadius),
							(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(3)), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity)).getBlockPos().getY() + 0
									+ Mth.nextDouble(RandomSource.create(), 0, 0.5) * particleRadius),
							(entity.level()
									...
									.getBlockPos().getZ() + 0 + Mth.nextDouble(RandomSource.create(), -1, 1) * particleRadius),
							(Mth.nextDouble(RandomSource.create(), 0, 0.005)), (Mth.nextDouble(RandomSource.create(), 0, 0.001)), (Mth.nextDouble(RandomSource.create(), 0, 0.005)));
					world.addParticle((SimpleParticleType) (EnteringyourmindModParticleTypes.MAGIC_24.get()), (entity.level()
							.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale((3 + Mth.nextInt(RandomSource.create(), 1, 10)))), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity))
							.getBlockPos().getX() + 0 + Mth.nextDouble(RandomSource.create(), -1, 1) * particleRadius),
							(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(3)), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity)).getBlockPos().getY() + 0
									+ Mth.nextDouble(RandomSource.create(), 0, 0.5) * particleRadius),
							(entity.level()
									.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale((3 + Mth.nextInt(RandomSource.create(), 1, 10)))), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE,
											entity))
									.getBlockPos().getZ() + 0 + Mth.nextDouble(RandomSource.create(), -1, 1) * particleRadius),
							(Mth.nextDouble(RandomSource.create(), -0.001, 0.005)), (Mth.nextDouble(RandomSource.create(), 0, 0.001)), (Mth.nextDouble(RandomSource.create(), 0, 0.005)));
				}
			}
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = EnteringyourmindModEntities.INVIS_MAGIC.get().spawn(_level, BlockPos.containing(x + 3, y, z + 3), MobSpawnType.MOB_SUMMONED);
