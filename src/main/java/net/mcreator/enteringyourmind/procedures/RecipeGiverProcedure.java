...
public class RecipeGiverProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if (EnteringyourmindModItems.TITANIUMITE.get() == itemstack.getItem()) {
			if (entity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.awardRecipesByKey(new ResourceLocation[]{new ResourceLocation("enteringyourmind:se_device_recipe")});
		}
	}
}
